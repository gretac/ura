...
test_that("Regex: (<0.1> | <1.0>)+ ", {
  ...
  r = processTrace(traceTimes, traceEvents, alphabetLength, intervals, "(<0.1> | <1.0>)+")
...
test_that("Regex: (<2.(1)+.0>)+ ", {
  ...
  r = processTrace(traceTimes, traceEvents, alphabetLength, intervals, "(<2.(1)+.0>)+")
...
test_that("Regex: <0.1.2.3> ", {
  ...
  r = processTrace(traceTimes, traceEvents, alphabetLength, intervals, "<0.1.2.3>")
